  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
      <div className="glass-panel rounded-3xl max-w-lg w-full p-6 sm:p-7 relative border border-stone-200/70 dark:border-stone-800/80 shadow-2xl">
        ...
        <div className="mb-5">
          <span className="text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-emerald-500/15 text-emerald-600 dark:text-emerald-400">
            Reporter Verification Required
          </span>
          <h2 className="text-lg font-bold text-stone-900 dark:text-stone-100 mt-2">
        ...
        {!decision && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
            <button
              ...
              className="flex flex-col items-center justify-center gap-2 p-5 rounded-2xl glass-card border border-emerald-500/30 hover:border-emerald-500 hover:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 transition-all group"
            >
            ...
            <button
              ...
              className="flex flex-col items-center justify-center gap-2 p-5 rounded-2xl glass-card border border-rose-500/30 hover:border-rose-500 hover:bg-rose-500/10 text-rose-600 dark:text-rose-400 transition-all group"
            >
        ...
        {decision === 'accept' && (
          <form onSubmit={handleAccept} className="space-y-4 pt-1">
            <div>
              <label className="block text-xs font-semibold text-stone-700 dark:text-stone-300 mb-2 text-center">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 rounded-xl text-xs glass-input focus:ring-2 focus:ring-amber-500/20"
              />
            </div>
            ...
            <div className="flex gap-2 pt-2">
              <button
                ...
                className="flex-1 py-2 rounded-xl text-xs font-semibold glass-card text-stone-500 hover:text-stone-700"
              >
                Back
              </button>
              <button
                type="submit"
                disabled={submitting}
                className="flex-2 py-2 px-4 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-emerald-500 to-teal-600 hover:opacity-95 shadow-lg flex items-center justify-center gap-1.5"
              >
          ...
          <form onSubmit={handleReopen} className="space-y-4 pt-1">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="flex-2 py-2 px-4 rounded-xl text-xs font-bold text-white bg-gradient-to-r from-rose-500 to-red-600 hover:opacity-95 shadow-lg flex items-center justify-center gap-1.5"
              >

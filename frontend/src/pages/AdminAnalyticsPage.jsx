  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="glass-card rounded-2xl p-5 border border-slate-200/70 dark:border-slate-800/80">
          ...
          <p className="text-[11px] text-slate-500 mt-1">Across all colleges & blocks</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-5 border border-slate-200/70 dark:border-slate-800/80">
          ...
          <p className="text-3xl font-extrabold text-cyan-500 mt-2">
        ...
        <div className="glass-card rounded-2xl p-5 border border-slate-200/70 dark:border-slate-800/80">
          ...
          <p className="text-[11px] text-slate-500 mt-1">Certified staff members</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Category Breakdown */}
        <div className="glass-panel rounded-3xl p-6 border border-slate-200/70 dark:border-slate-800/80 shadow-glass space-y-4">
      ...
      <div className="glass-panel rounded-3xl p-6 border border-slate-200/70 dark:border-slate-800/80 shadow-glass space-y-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-slate-400">Based on verified user ratings</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
          {workers.map((w) => (
            <div
              key={w.id}
              className="p-5 rounded-2xl glass-card border border-slate-200/70 dark:border-slate-800/80 space-y-4 hover:border-indigo-500/40 transition-all"
            >
              <div className="flex items-center gap-3">
                <img
                  ...
                  alt={w.name}
                  className="w-12 h-12 rounded-xl object-cover ring-2 ring-indigo-500/30 shadow-md"
                />
                <div>
                  <h4 className="text-sm font-bold text-slate-900 dark:text-slate-100">
                    {w.name}
                  </h4>
                  <p className="text-[11px] text-slate-400">{w.department}</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2 text-center">
                <div className="p-2 rounded-xl bg-slate-100/70 dark:bg-slate-900/60">
                ...
                <div className="p-2 rounded-xl bg-slate-100/70 dark:bg-slate-900/60">
                  <p className="text-lg font-extrabold text-cyan-500">{w.active}</p>
                  <p className="text-[9px] uppercase font-bold text-slate-400">In Progress</p>
                </div>
              </div>
            </div>
          ))}
